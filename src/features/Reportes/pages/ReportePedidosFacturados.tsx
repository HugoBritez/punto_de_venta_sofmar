import type { PedidosFacturadosProps } from "../../../shared/api/reportesRepository"
import { usePedidosFacturados } from "../../../shared/hooks/querys/useReportes"
import { useMemo, useState, useRef } from "react"
import { type ColumnDef, useReactTable, getSortedRowModel, getCoreRowModel, flexRender, getFilteredRowModel, type ColumnFiltersState } from "@tanstack/react-table"
          ...
          {isLoading ? (
            ...
            <div className="flex-1 overflow-hidden">
              <div
                ...
                className="overflow-auto max-h-[1000px] bg-white"
                style={{
                  position: 'relative',
                  scrollbarWidth: 'thin'
                }}
