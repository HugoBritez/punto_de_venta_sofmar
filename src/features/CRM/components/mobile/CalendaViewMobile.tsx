...
import { TareasDiasModalMobile } from "./TareasDiasModalMobile"
import { DetalleProyectoMobile } from "./DetalleProyectoMobile"

interface CalendarViewProps {
    oportunidades: OportunidadViewModel[]
    agendamientos: AgendamientosCRMModel[]
    onOportunidadClick?: (oportunidad: OportunidadViewModel) => void // Agregar esta prop
}

// Modal para mostrar tareas del día seleccionado


export const CalendarViewMobile = ({ 
    oportunidades, 
    agendamientos,
    onOportunidadClick 
}: CalendarViewProps) => {
    ...
    return (
        <>
            <div className="flex flex-col gap-2 p-2 bg-white shadow-sm w-full max-w-md mx-auto rounded-md min-h-screen">
                {/* Header del calendario */}
                <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-2">
                        <Calendar className="w-6 h-6 text-blue-600" />
                        <h3 className="font-bold text-lg text-gray-900">Calendario</h3>
                    </div>
                    <div className="flex items-center gap-2">
                        <button
                        ...
                        <span className="text-base font-semibold text-gray-700 min-w-[70px] text-center">
                    ...
                    {days.map((day, index) => {
                        ...
                        return (
                            <div
                                ...
                                className={`
                                    aspect-square p-0.5 cursor-pointer transition-colors flex items-center justify-center
                            ...
                            >
                                <div className="flex flex-col items-center justify-center h-full">
                                    ...
                                    <div className="flex gap-0.5 mt-0.5">
                                        {hasPendingTasks && <div className="w-1.5 h-1.5 bg-red-500 rounded-full" />}
                                        {hasAgendamientos && <div className="w-1.5 h-1.5 bg-blue-500 rounded-full" />}
                                        {hasRecordatorios && <div className="w-1.5 h-1.5 bg-orange-500 rounded-full" />}
                                    </div>
                                </div>
                            </div>
                        )
            ...
            {/* Modales igual, pero asegúrate que sean full-screen en mobile */}
            <TareasDiasModalMobile
