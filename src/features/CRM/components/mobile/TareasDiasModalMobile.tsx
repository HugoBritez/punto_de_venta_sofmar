import { BottomSheetComponent } from "@/shared/components/BottomSheet/BottomSheetComponent"
import { useState} from "react";
import { Calendar, Clock, CheckCircle, AlertCircle, Plus, CalendarDays, ListTodo, Bell } from "lucide-react";
...
export const TareasDiasModalMobile = ({
    isOpen, 
    onClose, 
    tareas, 
    fecha, 
            ...
            <div className="bg-white rounded-lg w-full h-full overflow-hidden">
                    ...
                    <div className="flex border-b border-gray-200">
                        <button
                            ...
                            className={`flex flex-row items-center gap-2 px-6 py-3 font-medium transition-colors ${
                                activeTab === "tareas"
                        ...
                        >
                            ...
                            <p className="text-xs ">Tareas ({tareas.length})</p>
                        </button>
                        <button
                        ...
                        >
                            ...
                            <p className="text-xs ">Agendamientos ({agendamientosDelDia.length})</p>
                        </button>
                        <button
                        ...
                        >
                            ...
                            <p className="text-xs ">Recordatorios ({recordatoriosDelDia.length})</p>
                        </button>
                    </div>
