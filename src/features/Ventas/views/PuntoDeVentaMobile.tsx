...
export const PuntoDeVentaMobile = () => {
                        ...
                        <div className="flex flex-col gap-3 bg-gray-50 p-3 rounded-md">
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">{formatNumber(totales.totalExentas)}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-600">Total 5%:</span>
                                    <span className="font-medium">{formatNumber(totales.totalCinco)}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-600">Total 10%:</span>
                                    <span className="font-medium">{formatNumber(totales.totalDiez)}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-600">Total Factura:</span>
                                    <span className="font-medium">{formatNumber(totales.totalAPagar)}</span>
                                </div>
                            </div>
                            ...
                            <div className="border-t pt-2">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-lg font-bold text-blue-600">{formatNumber(totales.totalAPagar)}</span>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    type="text"
                                    className="border rounded p-2 text-sm bg-black text-green-500 border-green-500 font-bold"
                                    value={montoEntregado > totales.totalAPagar ? formatNumber(montoEntregado - totales.totalAPagar) : "0"}
                                    readOnly
                                />
                            </div>
                        </div>
