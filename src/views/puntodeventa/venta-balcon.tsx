...
export default function VentaBalcon() {
  ...
  async function traerUltimaVentaId() {
    try{
      ...
      toast({
        title: "Error",
        description: "Ocurrió un error al intentar obtener el id de la ultima venta",
        status: "error",
        duration: 3000,
        isClosable: true,
      })
  ...
  async function actualizarUltimaFactura(codigo:number, numero:number) {
    try{
      ...
      toast({
        title: "Error",
        description: "Hubo un problema al actualizar la secuencia de la factura.",
        status: "error",
        duration: 5000,
        isClosable: true,
      });
  ...
  const ventaData = {
    venta: {
      ...
      ve_fecha: fecha,
      ve_factura: notaFiscal === 1? 0 : `${numeroEstablecimiento}-${numeroEmision}-${numeroFactura}`,
  ...
  const finalizarVenta = async () => {
    ...
    try {
      ...
      if (response.data && response.data.body) {
        ...
        actualizarUltimaFactura(Number(facturaData[0].d_nro_secuencia) + 1, facturaData[0].d_codigo )
        Auditar(
          5,
          8,
          newSaleID,
                ...
                >
                  ...
                  >
                    <Box>
                      ...
                      <Flex flexDirection={isMobile ? "row" : "column"} gap={2}>
                        <Button
