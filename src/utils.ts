export const api_url = 'https://node.sofmar.com.py:4016/api/'

export const api_url_secondary = 'https://node.sofmar.com.py:5016/api/'

//export const api_url = 'https://localhost:4000/api/'
//export const  api_url = 'https://db.sofmar.com.py:4009/api/' //acricolor
//export  const api_url = 'https://node.sofmar.com.py:4009/api/' //lobeck
//export  const api_url = 'https://node.sofmar.com.py:4020/api/' //distriwembe
...
export const fechaRelease = '19/07/2025'
export const db = 'sofmareas'
